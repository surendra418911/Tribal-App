                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            <a href="{{ route('sub.category.create') }}" class="btn btn-primary float-right">Add Sub Category</a>
                        </div>
                        <div class="card-body">
                                ...
                                <tbody>
                                    @foreach ($SubCategories as $category)
                                        <tr>
                                            ...
                                            <td>{{ ucwords($category->CategoryInfo->category_name) }}</td>
                                            <td>{{ ucwords($category->sub_category_name) }}</td>
                                            <td>
                                            ...
                                            <td>
                                                ...
                                                <a href="{{ route('sub.category.delete', $category->id) }}"
